...
/***/ "../assets/dev/js/editor/utils/helper.js":
/*!***********************************************!*\
  !*** ../assets/dev/js/editor/utils/helper.js ***!
  \***********************************************/
...
exports.maybeAddHelperSanitizeUrl = void 0;
var _dompurify = __webpack_require__(/*! dompurify */ "../node_modules/dompurify/dist/purify.js");
// To do: remove in 3.26.0.
const maybeAddHelperSanitizeUrl = () => {
  if (!!elementor.helpers.sanitizeUrl) {
    return false;
  }
  elementor.helpers.sanitizeUrl = url => {
    const isValidUrl = !!url ? (0, _dompurify.isValidAttribute)('a', 'href', url) : false;
    return isValidUrl ? url : '';
  };
};
exports.maybeAddHelperSanitizeUrl = maybeAddHelperSanitizeUrl;
...
/******/ 			if (chunkId === "mega-menu-editor") return "" + chunkId + ".c7a0b6827e67a5dd2350.bundle.js";
...
/******/ 			if (chunkId === "off-canvas-editor") return "" + chunkId + ".3501c11d63bc4f4d5b89.bundle.js";
...
var _helper = __webpack_require__(/*! ./utils/helper */ "../assets/dev/js/editor/utils/helper.js");
var ElementorPro = Marionette.Application.extend({
  ...
  initHelperFunctions() {
    (0, _helper.maybeAddHelperSanitizeUrl)();
  },
  ajax: {
    prepareArgs(args) {
      args[0] = 'pro_' + args[0];

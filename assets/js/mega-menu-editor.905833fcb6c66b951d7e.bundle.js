...
class View extends $e.components.get('nested-elements').exports.NestedView {
  ...
  renderDataBindings(settings, dataBindings, widget = []) {
    ...
    const renderDataBinding = async dataBinding => {
      if (!this.isAtomicExperimentActive() || !settings?.changed.__dynamic__ || !widget.length) {
        return false;
      }
  ...
  isAtomicDynamic(changedSettings, dataBinding, changedControl) {
    return dataBinding.el.hasAttribute('data-binding-dynamic') && this.isAtomicExperimentActive() && (this.itemTitle === changedControl || this.itemLink === changedControl);
  }
...
//# sourceMappingURL=mega-menu-editor.905833fcb6c66b951d7e.bundle.js.map